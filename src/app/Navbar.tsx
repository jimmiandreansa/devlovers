    ...
    >
      <Link href={"/"}>
        <div className="flex items-center">
          ...
          />
          <h1 className="text-2xl md:text-3xl text-main">
            <span className="font-bold">Dev</span>lovers
          </h1>
        </div>
      </Link>
      <div className="hidden md:flex space-x-4 items-center">
        <a href="/" className="text-main animated-underline">
      ...
      >
        ...
        <button className="block rounded-lg bg-main px-4 py-2 text-white w-full text-center transform transition-transform duration-300 hover:scale-105 hover:shadow-lg">
          Post A Billingual Job
        </button>
      </div>
    </nav>
